  ...
  SmallMultiples = function() {
    ...
    chart = function(selection) {
      return selection.each(function(rawData) {
        ...
        g.append("rect").attr("class", "background-ch").style("pointer-events", "all").attr("width", width + margin.right).attr("height", height).on("mouseover", mouseover).on("mousemove", mousemove).on("mouseout", mouseout);
        lines = g.append("g");
